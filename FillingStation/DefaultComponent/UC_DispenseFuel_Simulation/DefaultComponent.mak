...
UC_DispenseFuel.obj : UC_DispenseFuel.cpp UC_DispenseFuel.h    DispenseFuelPkg.h Cashier.h Camera.h Motorist.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"UC_DispenseFuel.obj" "UC_DispenseFuel.cpp" 



Cashier.obj : Cashier.cpp Cashier.h    ActorPkg.h UC_DispenseFuel.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Cashier.obj" "Cashier.cpp" 



Motorist.obj : Motorist.cpp Motorist.h    ActorPkg.h UC_DispenseFuel.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Motorist.obj" "Motorist.cpp" 



Camera.obj : Camera.cpp Camera.h    ActorPkg.h UC_DispenseFuel.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Camera.obj" "Camera.cpp" 



DispenseFuelPkg.obj : DispenseFuelPkg.cpp DispenseFuelPkg.h    UC_DispenseFuel.h UseCaseAnalysisPkg.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"DispenseFuelPkg.obj" "DispenseFuelPkg.cpp" 
...
InitWebResources.obj : InitWebResources.cpp     
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"InitWebResources.obj" "InitWebResources.cpp" 
...
clean:
	@echo Cleanup
	if exist UC_DispenseFuel.obj erase UC_DispenseFuel.obj
	if exist Cashier.obj erase Cashier.obj
	if exist Motorist.obj erase Motorist.obj
	if exist Camera.obj erase Camera.obj
	if exist DispenseFuelPkg.obj erase DispenseFuelPkg.obj
