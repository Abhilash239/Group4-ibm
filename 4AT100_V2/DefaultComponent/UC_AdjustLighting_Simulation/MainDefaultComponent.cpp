/********************************************************************
	...
	Model Element	: UC_AdjustLighting_Simulation
//!	Generated Date	: Mon, 8, Jun 2020  
	File Path	: DefaultComponent\UC_AdjustLighting_Simulation\MainDefaultComponent.cpp
*********************************************************************/
        ...
        if(OXF::initialize(0,NULL))
            {
                ...
                //#[ configuration DefaultComponent::UC_AdjustLighting_Simulation 
                //#]
                OXF::start();
                status = 0;
            }
