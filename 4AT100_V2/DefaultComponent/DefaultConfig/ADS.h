...
//#]
    ...
    //## auto_generated
    explicit ADS(IOxfActive* const theActiveContext = NULL);
    ...
    //## auto_generated
    const UC_DockTruck* getItsUC_DockTruck(void) const;
...
//#]
    ...
    UGE itsUGE;		//## classInstance itsUGE
