...
TARGET_NAME=component_6

all : $(TARGET_NAME)$(EXE_EXT) component_6.mak

TARGET_MAIN=Maincomponent_6
...
###############################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) component_6.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) component_6.mak
