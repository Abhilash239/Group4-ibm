...
TARGET_NAME=component_5

all : $(TARGET_NAME)$(EXE_EXT) component_5.mak

TARGET_MAIN=Maincomponent_5
...
###############################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) component_5.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) component_5.mak
