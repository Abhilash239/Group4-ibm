...
TARGET_NAME=component_4

all : $(TARGET_NAME)$(EXE_EXT) component_4.mak

TARGET_MAIN=Maincomponent_4
...
SystemConfiguration.obj : SystemConfiguration.cpp SystemConfiguration.h    Configuration.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"SystemConfiguration.obj" "SystemConfiguration.cpp" 



Configuration.obj : Configuration.cpp Configuration.h    SystemConfiguration.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Configuration.obj" "Configuration.cpp" 
...
###############################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) component_4.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) component_4.mak
	@echo Building library $@
	$(LIB_CMD) $(LIB_FLAGS) /out:$(TARGET_NAME)$(LIB_EXT) $(OBJS) $(ADDITIONAL_OBJS) $(LIBS)

clean:
	@echo Cleanup
	if exist SystemConfiguration.obj erase SystemConfiguration.obj
