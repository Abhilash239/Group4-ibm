...
block_2.obj : block_2.cpp block_2.h    AdjustHVACandLighting.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"block_2.obj" "block_2.cpp" 



AdjustHVACandLighting.obj : AdjustHVACandLighting.cpp AdjustHVACandLighting.h    block_2.h 
	$(CREATE_OBJ_DIR)
...
clean:
	@echo Cleanup
	if exist block_2.obj erase block_2.obj
