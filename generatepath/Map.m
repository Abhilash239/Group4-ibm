...
% To put constraints on parkinh zone
...
%To make area behind docing door to infinite cost
edge(1:51,1:780)=1;
...
% Docking Lines
edge(1:154,140+20)=0.3;
edge(1:154,140+20+28)=0.3;
edge(1:154,140+20+28*1+14*1)=0.3;
edge(1:154,140+20+28*2+14*1)=0.3;
edge(1:154,140+20+28*2+14*2)=0.3;
edge(1:154,140+20+28*3+14*2)=0.3;
edge(1:154,140+20+28*3+14*3)=0.3;
edge(1:154,140+20+28*4+14*3)=0.3;
edge(1:154,140+20+28*4+14*4)=0.3;
edge(1:154,140+20+28*5+14*4)=0.3;
edge(1:154,140+20+28*5+14*5)=0.3;
edge(1:154,140+20+28*6+14*5)=0.3;
edge(1:154,140+20+28*6+14*6)=0.3;
edge(1:154,140+20+28*7+14*6)=0.3;
edge(1:154,140+20+28*7+14*7)=0.3;
edge(1:154,140+20+28*8+14*7)=0.3;
edge(1:154,140+20+28*8+14*8)=0.3;
edge(1:154,140+20+28*9+14*8)=0.3;
edge(1:154,140+20+28*9+14*9)=0.3;
edge(1:154,140+20+28*10+14*9)=0.3;

% Human position value is given with 0.8
edge(x-w:x+w,z-w:z+w)=0;
